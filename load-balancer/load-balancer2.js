...
var options = {
    hostnameOnly: true,
    router: {
        "domainone.com": "localhost:8001",
        "domaintwo.net": "localhost:8002",
        "domainthree.org": "localhost:9003"
    }
};
...
var proxies = httpProxy.createServer(options).listen(8000);

// Get the next server and send the upgrade request.
proxies.on("upgrade", function (req, socket, head) {
